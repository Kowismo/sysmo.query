...
/**
  ...
  * @author     Stefan Zehnpfennig
  */
	public $runtime = array('socket' => '', 'selected' => false, 'host' => '', 'queryport' => '10011', 'timeout' => 2, 'debug' => array(), 'lost_events' => array(), 'fileSocket' => '', 'bot_clid' => '', 'bot_name' => '');
//*******************************************************************************************
//*************************************** Constants *****************************************
//*******************************************************************************************
  ...
  */
	public function executeCommand($command, $tracert = null) {
		...
		do {
            ...
            if(strstr(substr($data,0,7), 'notify') === false)
            {
                if(empty($data))
                {
                    $this->runtime['socket'] = $this->runtime['bot_clid'] = '';
